...
#
sudo powerpill -S kvantum flameshot python nerd-fonts-fira-code zsh zsh-completions kitty-git kitty-terminfo timeshift-bin timeshift-autosnap unzip cmake zoxide fzf
#
#
# 
#
