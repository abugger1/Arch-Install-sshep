...
#
#
  pikaur -S powerpill zramd timeshift-bin timeshift-autosnap
#
  systemctl enable --now zramd.service
#
  powerpill -S vivid kvantum flameshot python zsh zsh-completions kitty-git kitty-terminfo unzip cmake zoxide fzf
#
#
# 
#
